public struct Paragraph: Element {
    ...
    // MARK: Element
    public static let elements: [Element.Type] = [Emphasis.self, Image.self, InlineCode.self, InlineHTML.self, LineBreak.self, Link.self, SoftBreak.self, Strikethrough.self, Strong.self, Text.self]
