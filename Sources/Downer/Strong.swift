public struct Strong: Element {
    ...
    // MARK: Element
    public static let elements: [Element.Type] = [Emphasis.self, Image.self, InlineCode.self, LineBreak.self, Link.self, SoftBreak.self, Strikethrough.self, Text.self]
